 ...
 */
CommitmentTxPayload.fromBuffer = function fromBuffer(rawPayload, llmqOverride = {}) {
  ...
  console.log('CommitmentTxPayload.fromBuffer')
  console.dir(llmqOverride)

  const fixedCounterLength = QuorumEntry.getParams(payload.llmqtype, llmqOverride).size;
...
CommitmentTxPayload.prototype.toBuffer = function toBuffer(options) {
  ...
  console.log('CommitmentTxPayload.toBuffer')
  console.dir({})
