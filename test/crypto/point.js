...
describe("Point", function () {
  ...
  describe("#add", function () {
    it("should accurately add g to itself", function () {
      ...
      p3.getX()
        .toString()
        .should.equal(
          "89565891926547004231252920425935692360644145829622209" +
            "833684329913297188986597"
        );
      p3.getY()
        .toString()
        .should.equal(
          "12158399299693830322967808612713398636155367887041628" +
  ...
  describe("#mul", function () {
    it("should accurately multiply g by 2", function () {
      ...
      b.getX()
        .toString()
        .should.equal(
          "8956589192654700423125292042593569236064414582962220983" +
            "3684329913297188986597"
        );
      b.getY()
        .toString()
        .should.equal(
          "1215839929969383032296780861271339863615536788704162817" +
    ...
    it("should accurately multiply g by n-1", function () {
      ...
      b.getY()
        .toString()
        .should.equal(
          "83121579216557378445487899878180864668798711284981320763" +
  ...
  describe("#validate", function () {
    ...
    it("should describe this point as invalid because out of curve bounds", function () {
      ...
      var x =
        "FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEDCE6AF48A03BBFD25E8CD0364141";
      // calculated y of x
      var y =
        "ed3970f129bc2ca7c7c6cf92fa7da4de6a1dfc9c14da4bf056aa868d3dd74034";
