    ...
    },
    {
        ...
        message: function () {
            return (
                ...
                (arguments[1]
                    ? ' Documentation: ' + docsURL + arguments[1]
                    : '')
            )
        },
    },
            ...
            },
            {
                ...
                errors: [
                    ...
                    },
                    {
                        name: 'fieldsMismatch',
                        message:
                            'Mismatched number of addresses / amounts / proposals',
                    },
                    {
    ...
    },
    {
        ...
        errors: [
            ...
            },
            {
                ...
                errors: [
                    ...
                    },
                    {
                        name: 'Different',
                        message:
                            'Unspent value is different from specified fee: {0}',
                    },
                ],
            },
            {
            ...
            },
            {
                ...
                message:
                    "Lock Time can't be earlier than UNIX date 500 000 000",
            },
        ],
    },
    {
    ...
    },
    {
        ...
        errors: [
            ...
            },
            {
                ...
                message:
                    'Invalid entropy: must be a hex string or binary buffer, got {0}',
                errors: [
                    {
                        name: 'TooMuchEntropy',
                        message:
