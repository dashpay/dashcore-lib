...
describe('Address', function () {
    ...
    describe('bitcoind compliance', function () {
        validbase58.map(function (d) {
            if (!d[2].isPrivkey) {
                it(
                    'should describe address ' + d[0] + ' as valid',
                    function () {
                        var type
    ...
    describe('validation', function () {
        it('getValidationError detects network mismatchs', function () {
            var error = Address.getValidationError(
                '7XuDY2i34qGG3bsfdzbqhs2pRuFay7AsHz',
                'testnet'
            )
            should.exist(error)
        })
    ...
    describe('encodings', function () {
        ...
        it('should make this address from a compressed pubkey', function () {
            ...
            address
                .toString()
                .should.equal('XjN7vAMjVoRv1qM3wyi6QvAMUL3JySADS7')
        })
    ...
    it('can roundtrip from/to a object', function () {
        var address = new Address(P2SHLivenet[0])
        expect(new Address(address.toObject()).toString()).to.equal(
            P2SHLivenet[0]
        )
    })
    ...
    describe('creating a P2SH address from public keys', function () {
        ...
        it('can create an address from a set of public keys', function () {
            ...
            address
                .toString()
                .should.equal('7gcUDd12WP2VetJSk4RV2MYjQTdYKJVpCZ')
        ...
        it('works on testnet also', function () {
            ...
            address
                .toString()
                .should.equal('8tdHAwttdvR87BihpKRSUjN6HyQNVZsqBv')
        })
