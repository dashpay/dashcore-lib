...
QuorumEntry.prototype.isValidMemberSig = function isValidMemberSig(mnList) {
  ...
  var aggregatedSignature = BLS.Signature.fromBytes(
  ...
  var aggregationInfo = BLS.AggregationInfo.fromMsgHash(
    BLS.PublicKey.aggregate(pks), Uint8Array.from(this.getCommitmentHash())
  );
