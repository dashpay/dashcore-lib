 ...
 * @param {Object} [options.explicitVersion=false]
 * @return {SimplifiedMNListEntry}
 */
SimplifiedMNListEntry.fromBufferReader = function fromBuffer(bufferReader, network, options = {}) {
  const object = { };
  ...
  if (options.explicitVersion) {
    ...
    // Previous behavior to keep compatibility with previous dashcore-lib versions
 ...
 * @return {SimplifiedMNListEntry}
 */
SimplifiedMNListEntry.fromBuffer = function fromBuffer(buffer, network, options = {}) {
  const bufferReader = new BufferReader(buffer);

  this.fromBufferReader(bufferReader, network, options);
};
 ...
 * @return {Buffer}
 */
SimplifiedMNListEntry.prototype.toBuffer = function toBuffer(options = { }) {
  this.validate();
