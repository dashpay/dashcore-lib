    ...
    describe('GovObject - FromObject', function () {
        it('should cast a JSON Proposal into a Proposal Object', function () {
            ...
            var jsonProposal = {
                network: 'testnet',
                name: 'TestProposal',
                start_epoch: Math.round(
                    new Date('2015-10-10').getTime() / 1000
                ),
        ...
        it('should create a govObject from a buffer', function () {
            ...
            govFromBuffer
                .fromBuffer(govObject.toBuffer())
                .should.deep.equal(govObject)
            govFromBuffer
                .fromBuffer(govObject.toBuffer())
                .should.not.equal(govObject)
        ...
        it('should create a govObject from an Object', function () {
            ...
            new GovObject(
                Object._assign(new Object(), govObject)
            ).should.deep.equal(govObject)
            new GovObject(
                Object._assign(new Object(), govObject)
            ).should.not.equal(govObject)
            ...
            new GovObject(
                Object._assign(new Object(), govObject)
            ).should.deep.equal(govObject2.fromObject(jsonProposal))
            new GovObject(
                Object._assign(new Object(), govObject)
            ).should.not.equal(govObject2.fromObject(jsonProposal))
        })
        ...
        it('should be able to inspect a govObject', function () {
            ...
            govObject
                .inspect()
                .should.equal(
                    '<GovObject: ' + govObject.uncheckedSerialize() + '>'
                )
        })
