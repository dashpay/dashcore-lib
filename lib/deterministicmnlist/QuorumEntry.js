 ...
 * @param {SimplifiedMNList} SMNList - list for the block the quorum was mined in
...
QuorumEntry.prototype.getAllQuorumMembers = function getAllQuorumMembers(SMNList) {
  ...
  return MNList.calculateQuorum(this.getModifier());
};
 ...
 * @return {Buffer}
 */
QuorumEntry.prototype.getModifier = function getModifier() {
