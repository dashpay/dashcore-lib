...
var quorumEntryJSON = {
  "version": 1,
  "llmqType": 2,
  "quorumHash": "f2ef5ab062b348bfcf9f5be4c07b817e176a5726fa9b799ad67f690700000000",
  "signersCount": 400,
  ...
  "quorumVvecHash": "a2263a396ef747508bf75a2dd7f891abb0fc4fb58b6773d131eb0403126bdebe",
...
describe('QuorumEntry', function () {
  ...
  describe('commitmentHash', function () {
    it('Should be able to generate a correct commitmentHash', function () {
      var entry = new QuorumEntry(quorumCommitmentEntryJSON);
      var entryCommitmentHash = entry.getCommitmentHash();
      expect(entryCommitmentHash.toString('hex')).to.be.equal(commitmentHash);
    });
  });
});
