 ...
 */
ChainLock.prototype.verifySignatureAgainstQuorum = function verifySignatureAgainstQuorum(quorumEntry) {
  return new Promise(resolve => {
    var quorumPublicKey = quorumEntry.quorumPublicKey;
    var signature = this.signature;
    var signatureId = this.getSignatureIDForQuorumEntry(quorumEntry);
