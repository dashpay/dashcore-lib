...
/**
 * Tries verifying first with the default offset, then with 0 offset, then with double offset
 * @param {SimplifiedMNListStore} SMLStore - used to reconstruct quorum lists
 * @param {number} offset - we use this offset as a starting height to identify the signatory
