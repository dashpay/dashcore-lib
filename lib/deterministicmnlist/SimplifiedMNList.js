 ...
 * @constructor
 */
function SimplifiedMNList(simplifiedMNListDiff = null, llmqOverride = {}) {
...
SimplifiedMNList.prototype.applyDiff = function applyDiff(
  ...
  const diff = new SimplifiedMNListDiff(simplifiedMNListDiff, this.network, this.llmqOverride);
  ...
  function addAndMaybeRemoveQuorums(quorumEntries) {
    ...
    newQuorumsTypes.forEach((quorumType) => {
      ...
      const numberOfQuorumsToAdd = newGroupedQuorums[quorumType]
        ...
        : 0;
      console.log('addAndMaybeRemoveQuorums')
      console.dir(this.llmqOverride)
 ...
 * @param {Object} llmqOverride
 */
SimplifiedMNList.fromJSON = function fromJSON(smlJson, llmqOverride = {}) {
