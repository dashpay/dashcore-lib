    ...
    if (fExec && 0 <= opcodenum && opcodenum <= Opcode.OP_PUSHDATA4) {
        ...
        switch (opcodenum) {
            ...
            case Opcode.OP_CHECKSEQUENCEVERIFY:
                ...
                var nSequence = BN.fromScriptNumBuffer(
                    this.stack[this.stack.length - 1],
                    fRequireMinimal,
                    5
                )
                ...
                if (
                    (nSequence & Interpreter.SEQUENCE_LOCKTIME_DISABLE_FLAG) !=
                    0
                ) {
                    break
                }
            ...
            case Opcode.OP_EQUALVERIFY:
                //case Opcode.OP_NOTEQUAL: // use Opcode.OP_NUMNOTEQUAL
                {
                    ...
                    this.stack.pop()
                    this.stack.push(
                        fEqual ? Interpreter.true : Interpreter.false
                    )
            ...
            case Opcode.OP_WITHIN:
                {
                    ...
                    this.stack.pop()
                    this.stack.push(
                        fValue ? Interpreter.true : Interpreter.false
                    )
                }
                break
            ...
            case Opcode.OP_CHECKSIGVERIFY:
                {
                    ...
                    this.stack.push(
                        fSuccess ? Interpreter.true : Interpreter.false
                    )
