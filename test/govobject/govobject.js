...
describe("GovObject", function () {
  describe("GovObject - FromObject", function () {
    ...
    it("should create a govObject from an Object", function () {
      ...
      new GovObject(Object._assign(new Object(), govObject)).should.deep.equal(
        govObject
      );
      new GovObject(Object._assign(new Object(), govObject)).should.not.equal(
        govObject
      );

      new GovObject(Object._assign(new Object(), govObject)).should.deep.equal(
        govObject2.fromObject(jsonProposal)
      );
      new GovObject(Object._assign(new Object(), govObject)).should.not.equal(
        govObject2.fromObject(jsonProposal)
      );
    ...
    it("should be able to inspect a govObject", function () {
      ...
      govObject
        .inspect()
        .should.equal("<GovObject: " + govObject.uncheckedSerialize() + ">");
    });
