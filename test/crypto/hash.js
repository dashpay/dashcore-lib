...
describe('Hash', function () {
    ...
    describe('@sha1', function () {
        it('calculates the hash of this buffer correctly', function () {
            ...
            hash.toString('hex').should.equal(
                'de69b8a4a5604d0486e6420db81e39eb464a17b2'
            )
    ...
    describe('#sha256hmac', function () {
        it('computes this known big key correctly', function () {
            ...
            Hash.sha256hmac(data, key)
                .toString('hex')
                .should.equal(
                    'fb1f87218671f1c0c4593a88498e02b6dfe8afd814c1729e89a1f1f6600faa23'
                )
        })
    ...
    describe('#ripemd160', function () {
        it('calculates the hash of this buffer correctly', function () {
            ...
            hash.toString('hex').should.equal(
                'fa0f4565ff776fee0034c713cbf48b5ec06b7f5c'
            )
        })
