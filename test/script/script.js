...
describe('Script', function () {
    ...
    describe('#fromASM', function () {
        it('should parse this known script in ASM', function () {
            ...
            script.chunks[2].buf
                .toString('hex')
                .should.equal('f4c03610e60ad15100929cc23da2f3a799af1725')
    ...
    describe('#fromString', function () {
        it('should parse these known scripts', function () {
            ...
            Script.fromString('OP_0 3 0x010203 OP_0')
                .toString()
    ...
    describe('#isPushOnly', function () {
        it("should know these scripts are or aren't push only", function () {
            ...
            Script('OP_PUSHDATA1 5 0x1010101010')
                .isPushOnly()
                .should.equal(true)
    ...
    describe('#classifyInput', function () {
        ...
        it('should classify unknown', function () {
            Script('OP_TRUE OP_FALSE')
                .classifyInput()
                .should.equal(Script.types.UNKNOWN)
        })
        it("should classify scriptHashIn, eventhough it's opreturn", function () {
            Script(
                '6a1c3630fd3792f7e847ae5e27985dfb127542ef37ac2a5147c3b9cec7ba'
            )
                .classifyInput()
                .should.equal(Script.types.SCRIPTHASH_IN)
        })
    ...
    describe('#add and #prepend', function () {
        it('should add these ops', function () {
            ...
            Script()
                ...
                .add('OP_2')
                .toString()
                .should.equal('OP_1 OP_2')
            Script()
                .add(Opcode.OP_CHECKMULTISIG)
                .toString()
                .should.equal('OP_CHECKMULTISIG')
            Script()
                .add(Opcode.map.OP_CHECKMULTISIG)
                .toString()
                .should.equal('OP_CHECKMULTISIG')
        })
    ...
    describe('#buildPublicKeyHashOut', function () {
        it('should create script from livenet address', function () {
            var address = Address.fromString(
                'XxGJLCB7BBXAgA1AbgtNDMyVpQV9yXd7oB'
            )
        ...
        it('should create script from testnet address', function () {
            var address = Address.fromString(
                'ydDreK3fAT9V8fNHdXEUqCATJQYoEpACQn'
            )
            var s = Script.buildPublicKeyHashOut(address)
            should.exist(s)
            s.toString().should.equal(
            ...
            s.toAddress()
                .toString()
                .should.equal('ydDreK3fAT9V8fNHdXEUqCATJQYoEpACQn')
        })
    ...
    describe('#buildScriptHashOut', function () {
        ...
        it('inherits network property from other script', function () {
            var s1 = new Script.fromAddress(
                new Address('Xq8CM1PPLtBadKLBpLPFfaTH9Xio4M48cf')
            )
    ...
    describe('getData returns associated data', function () {
        ...
        it('for a P2PKH address', function () {
            ...
            expect(BufferUtil.equal(script.getData(), address.hashBuffer)).to.be
                .true
        })
        it('for a P2SH address', function () {
            var address = Address.fromString(
                '7hRXBxSmKqaJ6JfsVaSeZqAeyxvrxcHyV1'
            )
        ...
        it('for a standard opreturn output', function () {
            expect(
                BufferUtil.equal(
                    Script('OP_RETURN 1 0xFF').getData(),
                    Buffer.from([255])
                )
            ).to.be.true
        })
    ...
    describe('toAddress', function () {
        ...
        it('works for p2pkh output', function () {
            ...
            script
                .toAddress()
                .toString()
                .should.equal('XtzzeEiVCzMCApgvdbzv97VE4cXjQWEWZH')
        })
        it('works for p2pkh input', function () {
            ...
            s2.toAddress()
                .toString()
                .should.equal('XhB1gmkANwKJFJ6TU4nnf4dVviHUHzJ6FH')
        })

        it('works for p2sh output', function () {
            // taken from tx fe1f764299dc7f3b5a8fae912050df2b633bf99554c68bf1c456edb9c2b63585
            var script = new Script(
                'OP_HASH160 20 0x99d29051af0c29adcb9040034752bba7dde33e35 OP_EQUAL'
            )
            script
                .toAddress()
                .toString()
                .should.equal('7gRzPKA4QeNfW2cFfisEFNquif2caZzgaK')
        })
        it('works for p2sh input', function () {
            ...
            script
                .toAddress()
                .toString()
                .should.equal('7hGMSbENjrRZb5JWdnr9r8BhXtje4agm18')
        })

        // no address scripts
        it('works for OP_RETURN script', function () {
            var script = new Script(
                'OP_RETURN 20 0x99d29051af0c29adcb9040034752bba7dde33e35'
            )
    ...
    describe('#getSignatureOperationsCount', function () {
        ...
        it('should handle P2SH-multisig-in scripts from utility', function () {
            ...
            var signature =
                bitcore.crypto.Signature.fromString('30060201FF0201FF')
            var signatures = [signature.toBuffer()]
            var p2sh = Script.buildP2SHMultisigIn(
                pubKeyHexes,
                1,
                signatures,
                {}
