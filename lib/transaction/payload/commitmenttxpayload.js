 ...
 */
CommitmentTxPayload.fromBuffer = function fromBuffer(rawPayload, llmqParamsOverride = {}) {
  ...
  const fixedCounterLength = QuorumEntry.getParams(payload.llmqtype, llmqParamsOverride).size;
