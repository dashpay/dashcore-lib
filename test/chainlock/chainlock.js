...
describe('ChainLock', function() {
  var str = '';
  ...
  describe('validation', function (){
    ...
    describe('#getRequestId', function (){
      it('should compute the requestId', function(){
        var requestId = ChainLock.fromBuffer(buf2).getRequestId().toString('hex');
  ...
  describe('output', function (){
    ...
    describe('#inspect', function() {
      it('should output formatted output correctly', function() {
        var address = new ChainLock(str);
        var output = '<ChainLock: 259e20cd8e2c5c0d65558565f6abd1f222d4902f8f7d256acaca60df05010000, height: 382312>';
