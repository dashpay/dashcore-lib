...
async function verify() {
  const signatoryQuorum = this.selectSignatoryQuorum(this.getRequestId(), this.blockHash);
 ...
 */
ChainLock.prototype.selectSignatoryQuorum = function selectSignatoryQuorum(requestId, selectionHash) {
  const chainlockSML = SimplifiedMNListStore.getSMLbyHeight(this.height);
