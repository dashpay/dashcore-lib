...
describe('Signature', function () {
    ...
    describe('#fromCompact', function () {
        ...
        it('should create a signature from an uncompressed signature', function () {
            ...
            var r =
                'd5e61ab5bfd0d1450997894cb1a53e917f89d82eb43f06fa96f32c96e061aec1'
            var s =
                '2fc1188e8b0dc553a2588be2b5b68dbbd7f092894aa3397786e9c769c5348dc6'
                ...
                set.forEach(function (vector) {
                    ...
                    it(
                        ...
                        function () {
                            ...
                            var result = interp.checkSignatureEncoding(
    ...
    describe('#hasDefinedHashtype', function () {
        it('should reject invalid sighash types and accept valid ones', function () {
            ...
            var testCases = [
                ...
                [
                    (Signature.SIGHASH_ANYONECANPAY | Signature.SIGHASH_ALL) -
                        1,
                    false,
                ],
            ]
