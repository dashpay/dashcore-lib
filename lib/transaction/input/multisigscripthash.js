...
MultiSigScriptHashInput.prototype._deserializeSignatures = function (
    signatures
) {
...
MultiSigScriptHashInput.prototype.addSignature = function (
    transaction,
    signature
) {
    $.checkState(
...
MultiSigScriptHashInput.prototype.isValidSignature = function (
    transaction,
    signature
) {
