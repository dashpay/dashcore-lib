...
describe('SubTxCloseAccountPayload', function () {
    ...
    describe('.fromBuffer', function () {
        ...
        it('Should return instance of SubTxCloseAccountPayload with parsed data', function () {
            ...
            var parsedPayload =
                SubTxCloseAccountPayload.fromBuffer(payloadBuffer)
        ...
        it('Should throw an error if data is incomplete', function () {
            ...
            var payloadBufferWithoutCreditFee = payloadBuffer.slice(
                0,
                2 + 32 + 32
            )

            expect(function () {
                SubTxCloseAccountPayload.fromBuffer(
                    payloadBufferWithoutCreditFee
                )
            }).to.throw()
        })
    })
    ...
    describe('.fromJSON', function () {
        ...
        it('Should throw an error if the data is incorrect', function () {
            ...
            expect(function () {
                SubTxCloseAccountPayload.fromJSON(
        ...
        it('Should verify signature if pubKeyId is a Buffer', function () {
            ...
            expect(
                payload.verifySignature(
                    SubTxCloseAccountPayload.convertPrivateKeyToPubKeyId(
                        privateKey
                    )
                )
            ).to.be.true
