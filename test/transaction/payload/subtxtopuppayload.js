...
var validSubTxTopupPayloadHexString =
    '01003727f1b7e5aa90f32235d045fd4624bf453fe8e16ea5010ad923f70d2f88fd45'
var validSubTxTopupPayloadBuffer = Buffer.from(
    validSubTxTopupPayloadHexString,
    'hex'
)
var validSubTxTopupPayload = SubTxTopupPayload.fromBuffer(
    validSubTxTopupPayloadBuffer
)
...
describe('SubTxTopupPayload', function () {
    describe('.fromBuffer', function () {
        ...
        it('Should return instance of SubTxTopupPayload and call #validate on it', function () {
            var payload = SubTxTopupPayload.fromBuffer(
                Buffer.from(validSubTxTopupPayloadHexString, 'hex')
            )

            expect(payload.version).to.be.equal(1)
            expect(payload.regTxHash).to.be.equal(
                '45fd882f0df723d90a01a56ee1e83f45bf2446fd45d03522f390aae5b7f12737'
            )
        })
        ...
        it('Should throw in case if there is some unexpected information in raw payload', function () {
            var payloadWithAdditionalZeros = Buffer.from(
                validSubTxTopupPayloadHexString + '0000',
                'hex'
            )
    ...
    describe('#toJSON', function () {
        ...
        it('Should be able to serialize payload JSON', function () {
            ...
            expect(payloadJSON.regTxHash).to.be.equal(
                '45fd882f0df723d90a01a56ee1e83f45bf2446fd45d03522f390aae5b7f12737'
            )
        })
    ...
    describe('#toBuffer', function () {
        ...
        it('Should be able to serialize payload to Buffer', function () {
            ...
            var restoredPayload =
                SubTxTopupPayload.fromBuffer(serializedPayload)

            expect(restoredPayload.version).to.be.equal(1)
            expect(restoredPayload.regTxHash).to.be.equal(
                '45fd882f0df723d90a01a56ee1e83f45bf2446fd45d03522f390aae5b7f12737'
            )
        })
        it('Should call #validate', function () {
